...
<html>
<head>
<title>Live Food Admin Panel </title>
			...
			<div class="main-page">
				...
				<div class="grids">
					...
					<div class="panel panel-widget">
						<div class="inbox-page" id="category-page">
							<h4>Users</h4>
		...
		<!--footer-->
		 <div class="dev-page">
            ...
            <div class="dev-page-footer dev-page-footer-fixed"> 
				...
				<div class="container">
					<div class="copyright">
						<p>© 2017 StCS . All Rights Reserved . </a></p> 
					</div>
					<!-- page footer buttons -->
	...
	<!-- Bootstrap Core JavaScript --> 
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				function loadUsers(){
					$.get("get_users.php", {scope:"ALL"}, function(users_arr){
						for(var i in users_arr){

							var UsersTile = toUsersHtml(users_arr[i]);
							$('.inbox-page').append(UsersTile);
						}
					});
				}

				function toUsersHtml(user){
					return "<div class='inbox-row widget-shadow' id='accordion' role='tablist' aria-multiselectable='true'>" +
								...
								"<div class='mail'><img src='images/user.png' alt='' id='food-image'></div>" +
								"<div class='mail mail-name'> <h6>" + user.email + "</h6> </div>" +
								"<a role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse"+user.id+"' aria-expanded='true' aria-controls='collapse"+user.id+"'>" +
									"<div class='mail'><p> User Details </p></div>" +
								"</a>" +
								...
								"</div>" +
								"<div class='clearfix'> </div>" + 
								"<div id='collapse"+user.id+"' class='panel-collapse collapse' role='tabpanel' aria-labelledby='collapse"+user.id+"'>" +
									"<div class='mail-body'>" + 
										"<p> User Details </p> <br><br>" +
