...
<html>
<head>
<title>Strom Admin Panel</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Strom Control Systems, STCS, Strom Website, Strom Electronics, Electronics Store Zambia" />
								...
								<div class="form-body">
									<form action = "add-item-back.php" method="post" enctype="multipart/form-data"> 
										...
										<label for="exampleInputPassword1">Category  </label> <br>
										 <select id='item-category' name='catid'>
		...
		<!--footer-->
		 <div class="dev-page">
            ...
            <div class="dev-page-footer dev-page-footer-fixed"> 
				...
				<div class="container">
					<div class="copyright">
						<p>© 2017 Strom Control Systems. All Rights Reserved .</p> 
					</div>
					<!-- page footer buttons -->
